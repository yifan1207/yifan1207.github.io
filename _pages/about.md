...
title: about
permalink: /
subtitle: CS + Math @ <a href="https://www.ucla.edu/" target="_blank">UCLA</a> · Incoming MTS Intern @ <a href="https://openai.com/" target="_blank">OpenAI</a>
...
My broader interests also include **reinforcement learning**, **multi-agent systems**, and **efficient ML systems**. I have worked on multi-agent component analysis, agent behavior monitoring & evaluation, and CPU-efficient embedding inference (SimHash, int8 quantization, ONNX kernel fusion). 
